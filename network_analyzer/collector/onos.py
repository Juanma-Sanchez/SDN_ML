...
class DefaultOnosCollector(GenericCollector):
    ...
    def run(self):
        while self._current_traces < self._number_of_traces:
            # TODO retrieve trace from ONOS
            # TODO update recorded data
            # TODO if there is enough data, save to file and increase current trace
            break
